...
# Step 2: Load and summarize best practices for emails
...
# Step 3: Upload client’s brand and style guide
...
# Step 4: Upload client's Darts document
...
# Step 5: Upload content and select Dart
...
def summarize_brand_style(document):
    ...
    # Use OpenAI to generate a summary based on document content
...
def extract_darts(document):
    ...
    # Example: {"Dart 1": "Description", "Dart 2": "Description"}
    ...
    # Assuming the response is formatted as: "Dart 1: Description\nDart 2: Description\n..."
    darts = {line.split(":")[0].strip(): line.split(":")[1].strip() for line in dart_text.splitlines() if ":" in line}
    return darts

def extract_text(document):
    # Extract text from uploaded content document
